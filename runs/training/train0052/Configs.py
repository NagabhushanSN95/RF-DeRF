config = {
    ...
    'data_downsample': 2,
    'data_dirpath': '../../../../../databases/N3DV/data/all',
    # 'set_num': 6,
    # 'scene_names': ['cut_roasted_beef'],
    'set_num': 3,
    'num_frames': 300,
    ...
    'sparse_flow_dirnames': ['FEL001_FE03'],

    # Dense flow configs
    'dense_flow_dirnames': ['FEL003_FE03'],
    # 'dense_flow_mask_dirnames': ['FEL003_FV03'],
    ...
    # 'sparse_depth_dirnames': ['DEL001_DE03'],
