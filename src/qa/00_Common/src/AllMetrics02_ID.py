...
def demo1():
    root_dirpath = Path('../../')
    pred_train_dirpath = root_dirpath / 'runs/training/train1017'
    database_dirpath = root_dirpath / 'data/databases/InterDigital/data'
    gt_depth_dirpath = root_dirpath / 'data/dense_input_radiance_fields/Kplanes/runs/training/train1001'
